...
function twentyfourteen_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Catalog Sidebar', 'twentyfourteen' ),
        'id'            => 'sidebar-4',
        'description'   => __( 'Catalog sidebar that appears on the left.', 'twentyfourteen' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h1 class="widget-title">',
        'after_title'   => '</h1>',
...
function podarkoy_create_menu() {

    //create new top-level menu
    add_menu_page('Pod Arkoy', 'Pod Arkoy', 'administrator', __FILE__, 'pod_arkoy_settings_page', '/wp-content/themes/pod-arkoy/images/favicon.ico');
...
function pod_arkoy_settings_page() {
    ?>
    <div class="wrap">
        <h2>Pod Arkoy</h2>

        <form method="post" action="options.php">
            <?php settings_fields( 'pod_arkoy-settings-group' ); ?>
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row">Yandex Metrika</th>
                    <td><textarea style="width: 500px; height: 75px" name="pod_arkoy_ya_metrika"><?php echo get_option('pod_arkoy_ya_metrika'); ?></textarea></td>
                </tr>

                <tr valign="top">
                    <th scope="row">Yandex Informer</th>
                    <td><textarea style="width: 500px; height: 75px" name="pod_arkoy_ya_informer"><?php echo get_option('pod_arkoy_ya_informer'); ?></textarea></td>
                </tr>
            </table>

...
<table width="100%" class="shop-cart order-details">
    <tbody>
...
<?php
	if ( $order->billing_email ) echo '<strong>' . __( 'Email:', 'woocommerce' ) . '</strong> <span>' . $order->billing_email . '</span><br /><br />';
	if ( $order->billing_phone ) echo '<strong>' . __( 'Telephone:', 'woocommerce' ) . '</strong> <span>' . $order->billing_phone . '</span><br />';
...
<?php endif; ?>
        ...
        <strong>Адрес доставки</strong>: <span>
			<?php

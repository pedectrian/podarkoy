...
?>
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>" style="float:right;">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

    Общая сумма: <?php wc_cart_totals_subtotal_html(); ?>
<!--    <table cellspacing="0">-->
<!---->
